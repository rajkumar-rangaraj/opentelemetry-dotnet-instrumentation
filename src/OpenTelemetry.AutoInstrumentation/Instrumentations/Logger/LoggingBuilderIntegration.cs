...
public class LoggingBuilderIntegration
{
    ...
    public static CallTargetReturn OnMethodEnd<TTarget>(TTarget instance, Exception exception, CallTargetState state)
    {
        ...
        {
            var otelLoggerExtensionsType = Type.GetType("OpenTelemetry.AutoInstrumentation.Logger.LogBuilderExtensions, OpenTelemetry.AutoInstrumentation");
            var mi = otelLoggerExtensionsType?.GetMethod("AddOpenTelemetryLogs");
            mi?.Invoke(null, new[] { (object)instance });
        }
